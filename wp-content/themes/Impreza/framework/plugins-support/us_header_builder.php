...
if ( defined( 'US_HB_VERSION' ) AND version_compare( US_HB_VERSION, '2.2', '<' ) ) {
	...
	function us_update_ushb_notice() {
		...
		$output .= '<p>For correct work of your website header you need to update "Header Builder" to version 2.2 on the <a href="' . admin_url( 'plugins.php' ) . '">Plugins page</a>.<br>If you don\'t see the update notification there, just delete "Header Builder" plugin and install it again via ' . wp_get_theme() . ' > Addons page.</p>';
		$output .= '</div>';

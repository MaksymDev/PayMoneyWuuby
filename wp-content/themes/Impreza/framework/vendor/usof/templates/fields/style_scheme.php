...
foreach ( $style_schemes as $key => &$style_scheme ) {
	...
	$output .= '<span class="preview_text" style="color:' . $style_scheme['values']['color_content_text'] . ';">' . strip_tags( $style_scheme['title'] ) . '</span>';
	$output .= '</div></li>';
}
...
$output .= '<button id="save_new_style_scheme" class="usof-button" disabled><span>' . _x( 'Save as new', 'color scheme', 'us' ) . '</span>';
$output .= '<span class="usof-preloader"></span></button>';

$output .= '<button id="save_current_style_scheme" class="usof-button" disabled><span>' . _x( 'Save current', 'color scheme', 'us' ) . '</span>';
$output .= '<span class="usof-preloader"></span></button>';
$output .= '</div></div>';
